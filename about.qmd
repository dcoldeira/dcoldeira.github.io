...
**Current Projects:**
- **Quantum Relational Language (QRL)**: Relations-first quantum programming where entanglement is first-class
...
- QRL: Relations-first quantum programming language
...
Domain knowledge drives architecture. Understanding quantum mechanics shapes how QRL handles entanglement. Understanding soil mechanics influences geotechnical data pipelines.
...
- Comprehensive testing (QRL: 100% test pass rate)
- Clear documentation
...
- Fix bugs thoroughly (see: QRL cross-basis measurement bug fix)
...
QRL now supports arbitrary n-qubit entanglement:
...
Building quantum type system and process composition for QRL.
