...
**[GitHub Repository](https://github.com/dcoldeira/quantum-relational-language) | [Documentation](https://github.com/dcoldeira/quantum-relational-language#readme) | 2025 | Active Development**

A quantum programming language built from first principles where entanglement is a first-class citizen. Not another gate-based framework—this is **relations-first quantum programming**.

**Recent Milestones:**

- ✅ **Stage 0 Complete** (Dec 2025): 2-qubit Bell states, correct cross-basis measurements, entanglement tracking
- ✅ **Stage 1 Complete** (Dec 2025): n-qubit GHZ & W states, arbitrary entanglement (tested to 5 qubits), partial measurements
- 🔜 **Stage 2 Next**: Process algebra, quantum type system, gate application
...
### Quantum Advisor
**[GitHub](https://github.com/dcoldeira/quantum-relational-language/tree/main/quantum_advisor) | 2025**
...
Domain knowledge drives architecture. Understanding quantum mechanics shapes how QRL handles entanglement. Understanding physics is not optional—it's the foundation.
...
Research code shouldn't be throwaway. Build with testing, documentation, and maintainability from day one. QRL has 100% test pass rate because correctness matters.

**Rigorous Physics**

Get the math right. QRL's cross-basis bug fix (Stage 0) demonstrated: assumptions must be tested, quantum mechanics is unforgiving, and correct physics is non-negotiable.
...
- "Quantum Computing Foundations: The Theory Behind QRL" - Complete quantum mechanics primer
- "Stage Zero: Programming Quantum Reality Through Relations, Not Gates" - QRL philosophy and implementation
...
- **Gmail:** [dcoldeira](mailto:dcoldeira@gmail.com)
