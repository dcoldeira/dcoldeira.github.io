...
description: "Gates are not how quantum mechanics works. QRL is adopting Measurement-Based Quantum Computing (MBQC) as its compilation target—not because it's easier, but because it's what the physics actually says. Here's the theory, the motivation, and the research program ahead."
image: "mbqc-paradigm.png"
---
...
**Development Timeline:** Research into this direction began in November 2025. This post was written later to document the decision and theoretical foundations.
:::
...
QRL didn't **choose** MBQC—the relations-first model **naturally expresses** MBQC.
...
4. **Photonic backend**
   ...
   - QRL → Strawberry Fields compilation
...
1. **Surface code compilation**
   - QRL relations → surface code stabilizer measurements
...
2. **Compiler Design**
   - QRL → MBQC measurement pattern compilation
...
3. **RQ3:** Does QRL → MBQC produce more efficient patterns than gate-based → MBQC?
...
| **QRL** | **Relations-first → MBQC** | Photonic, surface codes | Early stage (Stage 1) |
