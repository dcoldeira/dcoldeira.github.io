---
title: "Why QPL is Adopting Measurement-Based Quantum Computing"
author: "David Coldeira"
date: "2026-01-02"
categories: [quantum computing, QPL, MBQC, research, quantum foundations]
description: "Gates are not how quantum mechanics works. QPL is adopting Measurement-Based Quantum Computing (MBQC) as its compilation target—not because it's easier, but because it's what the physics actually says. Here's the theory, the motivation, and the research program ahead."
...
**Measurements:**
1. Measure $a_1$ in X basis → outcome $s_1$
2. Measure $a_2$ in basis $\theta = 0 + s_1 \pi$ → outcome $s_2$
...
**Deliverables:**
- `qpl_program.compile(target="mbqc")` → measurement pattern
- Integration with Strawberry Fields
- Example: Compile QPL teleportation to photonic MBQC

**Success criteria:**
- QPL programs run on photonic quantum computers without gate layer
...
**Deliverables:**
- QPL simulates 50+ qubit MBQC programs efficiently
...
**Long-term vision:**
- QPL becomes a **high-level language for fault-tolerant quantum computing**
...
4. Briegel, H. J., Browne, D. E., Dür, W., Raussendorf, R., & Van den Nest, M. (2009). Measurement-based quantum computation. *Nature Physics*, 5(1), 19-26. [DOI: 10.1038/nphys1157](https://www.nature.com/articles/nphys1157)
