...
[Stage Zero](https://dcoldeira.github.io/posts/2025-12-29-qpl-stage-zero/) of QRL proved something critical: **relations-first quantum programming works**. You can build a quantum language where entanglement is a first-class citizen, measurements are contextual questions, and the physics is textbook-correct.
...
This is **textbook quantum mechanics** ([Nielsen & Chuang, Chapter 11](https://en.wikipedia.org/wiki/Quantum_Computation_and_Quantum_Information)). But in QRL, it's **built into the language**—not something you calculate in user code.
...
*Next post: Stage 2 implementation—quantum type systems and process algebra for QRL.*
