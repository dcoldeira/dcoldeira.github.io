...
date: "2025-12-31"
categories: [quantum computing, QPL, physics, GHZ states, entanglement, tensor networks]
...
[Stage Zero](https://dcoldeira.github.io/posts/2025-12-29-qpl-stage-zero/) of QPL proved something critical: **relations-first quantum programming works**. You can build a quantum language where entanglement is a first-class citizen, measurements are contextual questions, and the physics is textbook-correct.
...
- Under local operations and classical communication (LOCC), you **cannot convert** GHZ ↔ W
...
3. **Different LOCC equivalence class:** Cannot convert W ↔ GHZ with local operations
...
This is **textbook quantum mechanics** ([Nielsen & Chuang, Chapter 11](https://en.wikipedia.org/wiki/Quantum_Computation_and_Quantum_Information)). But in QPL, it's **built into the language**—not something you calculate in user code.
...
4. Updating the state dimension (8D → 4D for 3→2 qubits)
...
With n-qubit support, QPL can now express:
...
- Denotational semantics for QPL programs
...
QPL Stage 1 is ready: [github.com/dcoldeira/quantum-process-language](https://github.com/dcoldeira/quantum-process-language)
