---
title: "Stage 2 Complete: QPL Now Compiles to MBQC Patterns"
author: "David Coldeira"
date: "2026-01-12"
categories: [quantum computing, QPL, MBQC, quantum teleportation, compiler, measurement patterns]
description: "The MBQC compiler is working! QPL now extracts graph states, generates measurement patterns, and performs quantum teleportation with adaptive corrections. Here's what changed and why it matters."
image: "qpl-stage-two.svg"
---

::: {.callout-tip icon=false}
## 🔗 Quantum Process Language (QPL) Repository

This post documents QPL Stage 2 development. View the source code, run examples, and contribute:

**[GitHub: dcoldeira/quantum-process-language](https://github.com/dcoldeira/quantum-process-language)**
...
[Stage 1](https://dcoldeira.github.io/posts/2025-12-31-qpl-stage-one/) gave QPL the ability to work with arbitrary n-qubit quantum relations. You could create GHZ states, W states, measure qubits, and track entanglement entropy across any bipartition.

But there was a missing piece: **How do you actually *run* these quantum programs on real hardware?**

That's what Stage 2 solves. **QPL now compiles relations-first quantum programs into measurement-based quantum computing (MBQC) patterns.**
...
**New module:** `src/qpl/mbqc/graph_extraction.py` (204 lines)
...
**New module:** `src/qpl/mbqc/pattern_generation.py` (300 lines)
...
**Pattern components:**
- **Preparation:** Which qubits to initialize in |+⟩
...
**New module:** `src/qpl/mbqc/adaptive_corrections.py` (280 lines)
...
Before Stage 2, QPL could *represent* quantum programs using relations. Now it can *compile* them to executable patterns.

This opens the door to running QPL on real quantum hardware.
...
QPL targets MBQC from the start, not as an afterthought.
...
- ✅ Adaptive quantum operations
- ✅ State preservation (fidelity)
...
Stage 2 proves QPL can compile to MBQC patterns. But patterns are still abstract.
...
**Stay tuned for the next post:** "QPL Meets Photonics: The Path to Real Quantum Hardware"
...
**Core modules:**
- `src/qpl/mbqc/measurement_pattern.py` - Data structures
- `src/qpl/mbqc/graph_extraction.py` - Graph state extraction
- `src/qpl/mbqc/pattern_generation.py` - Pattern compilation
- `src/qpl/mbqc/adaptive_corrections.py` - Quantum teleportation
...
- **X basis**: Measures superposition (|+⟩/|-⟩)
- **Y basis**: Measures complex phase
- **Z basis**: Measures computational (|0⟩/|1⟩)
...
Relations-first programming naturally captures these dependencies. That's why QPL → MBQC compilation feels natural.
...
- **graphix-perceval** - MBQC → photonic circuit compilation
...
1. ✅ Relations-first quantum programming
2. ✅ n-qubit quantum relations
3. ✅ MBQC pattern compilation
4. 🚀 Photonic hardware integration
5. 🔜 Real quantum computers
...
**"QPL Meets Photonics: The Path to Real Quantum Hardware"**

How QPL patterns compile to photonic circuits using graphix and Perceval. Why photonic quantum computers are MBQC-native. And how QPL could be the first relations-based compiler for photonic QC.
...
**Want to contribute?** QPL is open source! Check out the [GitHub repo](https://github.com/dcoldeira/quantum-process-language) and the [issues page](https://github.com/dcoldeira/quantum-process-language/issues).
