---
title: "QPL Meets Photonics: The First Relations-Based Compiler for Photonic Quantum Computers"
author: "David Coldeira"
date: "2026-01-15"
categories: [quantum computing, QPL, photonic QC, MBQC, Quandela, Perceval, graphix, hardware]
description: "Photonic quantum computers are MBQC-native. QPL's relations-first approach compiles directly to photonic circuits, bypassing gate decomposition entirely. This changes everything."
...
- **HWP** (half-wave plate) - Prepare |+⟩ states
...
**Superconducting qubits:** T₁ ~ 100 μs, T₂ ~ 50 μs
Gates must execute before decoherence destroys quantum states.

**Photons:** T₁ = ∞ (photons don't decay)
...
**Status:**
- ✅ Step 1-2: Working (Stage 2 complete)
- 🚧 Step 3: Next to implement
- ✅ Step 4-5: graphix-perceval exists (studied source code)
- ⏳ Step 6: Quandela Cloud access (will apply)
...
**Qiskit?** Gates → circuits → MBQC transpiler (if you write it)
**Cirq?** Gates → circuits (no MBQC)
**Strawberry Fields?** Continuous variables (different model)
**QPL?** Relations → MBQC natively
...
1. Decompose gates → circuits
2. Synthesize circuits → MBQC patterns
3. Compile patterns → resource graphs
...
7. **First QPL program on real photonic QPU**
...
- **QPL** - Only relations-first + MBQC-native + photonic-targeting language
...
**Short term:** QPL programs compile to graphix patterns
...
- Benchmark QPL vs gate-based compilation
...
- **Contribute:** [GitHub Issues](https://github.com/dcoldeira/quantum-process-language/issues)
- **Discuss:** [GitHub Discussions](https://github.com/dcoldeira/quantum-process-language/discussions)
